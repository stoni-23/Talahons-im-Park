...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BbCHSM5_.js
var routes_BbCHSM5__exports = /* @__PURE__ */ __exportAll({
	C: () => stopParkAmbience,
	S: () => stopOmaKommando,
	T: () => unlockAudio,
	_: () => resumeAudio,
...
var GameEngine = class {
	...
	spawnCarpet() {
		...
		import("./audio-Dpejm88p.mjs").then((a) => a.playTalahinIntro());
		const fromRight = Math.random() < .5;
		const speed = 190;
		this.targets.push({
			...this.baseTarget(),
	...
	spawnRocker() {
		...
		import("./audio-Dpejm88p.mjs").then((a) => a.playRocker());
		const fromRight = Math.random() < .5;
		const speed = 260;
		this.targets.push({
			...this.baseTarget(),
