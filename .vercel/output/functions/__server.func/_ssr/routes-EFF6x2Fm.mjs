...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-EFF6x2Fm.js
var routes_EFF6x2Fm_exports = /* @__PURE__ */ __exportAll({
	C: () => stopParkAmbience,
	S: () => stopOmaKommando,
	T: () => unlockAudio,
	_: () => resumeAudio,
...
var GameEngine = class {
	...
	spawnCarpet() {
		...
		import("./audio-Cax8lbIR.mjs").then((a) => a.playTalahinIntro());
		const fromRight = Math.random() < .5;
		const speed = 190;
		this.targets.push({
			...this.baseTarget(),
	...
	spawnRocker() {
		...
		import("./audio-Cax8lbIR.mjs").then((a) => a.playRocker());
		const fromRight = Math.random() < .5;
		const speed = 260;
		this.targets.push({
			...this.baseTarget(),
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														...
														children: ["Lv.", isMe ? getPlayerLevel(Math.max(profile.totalXp || 0, row.score)) : getPlayerLevel(row.score)]
													}),
