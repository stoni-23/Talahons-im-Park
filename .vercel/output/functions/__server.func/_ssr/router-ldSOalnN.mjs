...
//#region node_modules/.nitro/vite/services/ssr/assets/router-ldSOalnN.js
var router_ldSOalnN_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-CbfzuzwG.mjs").then((n) => n.E);
...
//#endregion
export { getRouter, router_ldSOalnN_exports as t };
