...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DgS5kHzB.js
var router_DgS5kHzB_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-B7NE_eXq.mjs").then((n) => n.E);
...
//#endregion
export { getRouter, router_DgS5kHzB_exports as t };
