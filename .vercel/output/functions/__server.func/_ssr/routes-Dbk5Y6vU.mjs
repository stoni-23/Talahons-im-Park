...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Dbk5Y6vU.js
var routes_Dbk5Y6vU_exports = /* @__PURE__ */ __exportAll({
	C: () => stopParkAmbience,
	S: () => stopOmaKommando,
	T: () => unlockAudio,
	_: () => resumeAudio,
...
function claimDailyReward(profile) {
	const status = getDailyRewardStatus(profile);
	if (!status.canClaim) throw new Error("Heute bereits abgeholt!");
	...
	if (reward.badgeId) {
		if (!currentInventory.includes(reward.badgeId)) currentInventory.push(reward.badgeId);
...
var DailyRewardModal = ({ isOpen, onClose, profile, onProfileUpdate }) => {
	if (!isOpen) return null;
	const status = getDailyRewardStatus(profile);
	const [successMsg, setSuccessMsg] = import_react.useState(null);
	const handleClaim = () => {
		try {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				successMsg && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "my-2 w-full rounded-lg bg-emerald-500/20 border border-emerald-500/50 p-2 text-xs font-bold text-emerald-300 animate-pulse",
					children: successMsg
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				status.canClaim ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: handleClaim,
...
var GameEngine = class {
	...
	spawnCarpet() {
		...
		import("./audio-Dz7nzYoO.mjs").then((a) => a.playTalahinIntro());
		const fromRight = Math.random() < .5;
		const speed = 190;
		this.targets.push({
			...this.baseTarget(),
	...
	spawnRocker() {
		...
		import("./audio-Dz7nzYoO.mjs").then((a) => a.playRocker());
		const fromRight = Math.random() < .5;
		const speed = 260;
		this.targets.push({
			...this.baseTarget(),
