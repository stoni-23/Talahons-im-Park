...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BvHwvYBj.js
var router_BvHwvYBj_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-DRGGippM.mjs").then((n) => n.E);
...
//#endregion
export { getRouter, router_BvHwvYBj_exports as t };
