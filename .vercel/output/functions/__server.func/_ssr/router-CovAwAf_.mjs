...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CovAwAf_.js
var router_CovAwAf__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-BhLPq7tf.mjs").then((n) => n.E);
...
//#endregion
export { getRouter, router_CovAwAf__exports as t };
