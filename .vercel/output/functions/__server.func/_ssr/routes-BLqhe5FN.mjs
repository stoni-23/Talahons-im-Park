...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BLqhe5FN.js
var routes_BLqhe5FN_exports = /* @__PURE__ */ __exportAll({
	C: () => stopParkAmbience,
	S: () => stopOmaKommando,
	T: () => unlockAudio,
	_: () => resumeAudio,
...
var GameEngine = class {
	...
	spawnCarpet() {
		...
		import("./audio-ClpW_aue.mjs").then((a) => a.playTalahinIntro());
		const fromRight = Math.random() < .5;
		const speed = 190;
		this.targets.push({
			...this.baseTarget(),
	...
	spawnRocker() {
		...
		import("./audio-ClpW_aue.mjs").then((a) => a.playRocker());
		const fromRight = Math.random() < .5;
		const speed = 260;
		this.targets.push({
			...this.baseTarget(),
