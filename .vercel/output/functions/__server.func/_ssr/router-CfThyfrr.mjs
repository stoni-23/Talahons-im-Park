...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CfThyfrr.js
var router_CfThyfrr_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-CGfhE0i6.mjs").then((n) => n.E);
...
//#endregion
export { getRouter, router_CfThyfrr_exports as t };
