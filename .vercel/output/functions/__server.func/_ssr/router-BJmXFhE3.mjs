...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BJmXFhE3.js
var router_BJmXFhE3_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var APP_NAME = "Bankgeheimnis im Park";
var Route$1 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				property: "og:title",
				content: "Bankgeheimnis im Park – Moorhuhn-Action"
			},
			{
				property: "og:description",
				content: "Die Oma, die Parabellum und zu viele Talahons im Park. Knacke den Highscore!"
			},
			{
				property: "og:image",
				content: "https://talahons-im-park.vercel.app/logo.png"
			},
			{
				property: "og:url",
				content: "https://talahons-im-park.vercel.app"
			},
			{
				property: "og:type",
				content: "website"
...
var $$splitComponentImporter = () => import("./routes-CDyWZ0ms.mjs").then((n) => n.E);
...
//#endregion
export { getRouter, router_BJmXFhE3_exports as t };
