...
import { LogOut, Pause, Play, Share2, Smartphone, User, Volume2, VolumeX } from "lucide-react";
...
//#endregion
//#region src/components/kiosk-modal.tsx
				...
				children: [
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("span", { children: currentCoins }),
									/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: "🏪" }), "Kiosk"]
							...
							children: [
								...
								hasNewItemInModal && /* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: "Alle"
						}), SHOP_CATEGORIES.map((cat) => /* @__PURE__ */ jsxs("button", {
							type: "button",
							...
							children: [/* @__PURE__ */ jsx("span", { children: cat.icon }), /* @__PURE__ */ jsx("span", { children: cat.label })]
						}, cat.id))]
					})
				]
			}), /* @__PURE__ */ jsx("div", {
				...
				children: visibleItems.length === 0 ? /* @__PURE__ */ jsx("div", {
					...
					return /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							className: "shrink-0",
							children: activeTab === "shop" ? purchased ? /* @__PURE__ */ jsx("button", {
								type: "button",
								disabled: true,
							...
							}) : item.available === false ? /* @__PURE__ */ jsx("button", {
								type: "button",
								disabled: true,
...
//#endregion
//#region src/lib/daily-reward.ts
...
//#endregion
//#region src/components/daily-reward-modal.tsx
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: DAILY_REWARD_DAYS.map((item) => {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								isClaimed ? /* @__PURE__ */ jsx("span", {
									className: "mt-1 text-[9px] font-bold text-emerald-400",
									children: "✓ Erhalten"
								}) : isTodayTarget ? /* @__PURE__ */ jsx("span", {
				...
				status.canClaim ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: handleClaim,
...
//#endregion
//#region src/components/missions-modal.tsx
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: [/* @__PURE__ */ jsx("h2", {
							...
							}), claimable.length > 0 && /* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [/* @__PURE__ */ jsxs("span", { children: [
									...
									totalCoins,
									" 🪙"
								] }), /* @__PURE__ */ jsx("span", { children: "Holen" })]
							})]
						}), /* @__PURE__ */ jsx("p", {
						...
						className: "flex items-center gap-2",
						children: [claimable.length > 0 ? /* @__PURE__ */ jsxs("button", {
							type: "button",
							onClick: handleClaimAll,
							...
							children: [/* @__PURE__ */ jsx("span", { children: "🪙" }), /* @__PURE__ */ jsxs("span", { children: ["+", totalCoins] })]
						}) : /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: "🪙" }), /* @__PURE__ */ jsx("span", { children: "30 Max" })]
						}), /* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: onClose,
				...
				claimable.length > 0 && /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsxs("span", { children: ["🪙 ", claimable.length === 1 ? "Groschen einstecken" : "Alle Groschen einstecken"] }), /* @__PURE__ */ jsxs("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [missions.map((m) => {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								className: "mt-2.5",
								children: laserClaimed ? /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", { children: "✓" }), /* @__PURE__ */ jsx("span", { children: "Giftgrün-Laser in der Handtasche & aktiv!" })]
								}) : allCompleted ? /* @__PURE__ */ jsxs("button", {
									type: "button",
									...
									children: [/* @__PURE__ */ jsx("span", {
										className: "text-sm",
										children: "🟢"
									}), /* @__PURE__ */ jsx("span", { children: "JETZT ABHOLEN: Giftgrün-Laser freischalten!" })]
								}) : /* @__PURE__ */ jsxs("span", {
...
var GameEngine = class {
	...
	spawnCarpet() {
		...
		import("./audio-Dz7nzYoO.js").then((a) => a.playTalahinIntro());
		const fromRight = Math.random() < .5;
		const speed = 190;
		this.targets.push({
			...this.baseTarget(),
	...
	spawnRocker() {
		...
		import("./audio-Dz7nzYoO.js").then((a) => a.playRocker());
		const fromRight = Math.random() < .5;
		const speed = 260;
		this.targets.push({
			...this.baseTarget(),
...
//#endregion
//#region src/components/game-screen.tsx
...
function GameScreen() {
	...
	const [kioskTab, setKioskTab] = React.useState("shop");
	...
	const pendingMissionActsRef = useRef([]);
	const [hud, setHud] = useState(emptyHud());
	const [omaLine, setOmaLine] = useState(false);
	const [board, setBoard] = useState([]);
	const [boardTab, setBoardTab] = useState("highscore");
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!playing && /* @__PURE__ */ jsx("div", {
			...
			children: [
				...
				hud.mode === "title" && /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("p", {
										...
										children: [/* @__PURE__ */ jsx(User, { className: "size-3.5 text-amber-400" }), " Profil"]
									}), /* @__PURE__ */ jsxs("span", {
								...
								}), !isEditing && profile.name ? /* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("span", {
													...
													children: [getActiveBadgeIcon(profile?.equipped) && /* @__PURE__ */ jsx("span", {
											...
											/* @__PURE__ */ jsxs("button", {
												...
												children: [/* @__PURE__ */ jsx(LogOut, { className: "size-3.5" }), " Abmelden"]
											})
										]
									}), !isSecured && /* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [profile.name && !isEditing && /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("button", {
										...
										return /* @__PURE__ */ jsxs("button", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-white animate-ping" }), "ABHOLEN!"]
											}) : /* @__PURE__ */ jsxs("span", {
								...
								}), profile.name && !isEditing && /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx("span", { children: "🏪" }), /* @__PURE__ */ jsx("span", { children: "Kiosk" })]
									}), /* @__PURE__ */ jsxs("button", {
										type: "button",
										onClick: () => {
										...
										children: [
											...
											hasHandbagNotification && /* @__PURE__ */ jsxs("span", {
												className: "absolute -top-1 -right-1 flex h-3 w-3",
												children: [/* @__PURE__ */ jsx("span", { className: "animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75" }), /* @__PURE__ */ jsx("span", { className: "relative inline-flex rounded-full h-3 w-3 bg-red-500 border border-neutral-900" })]
											})
										]
									})]
								})]
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										board.length > 5 && /* @__PURE__ */ jsx("button", {
											type: "button",
								...
								}), board.length > 0 ? /* @__PURE__ */ jsx("ol", {
							...
							!isEditing && profile?.name && /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: chatMsgs.length === 0 ? /* @__PURE__ */ jsx("p", {
											className: "text-xs text-muted text-center mt-4",
											children: "Noch keine Nachrichten..."
										}) : chatMsgs.map((msg, i) => /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("li", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("span", { children: "🧶 Stricknadelkommando" }), /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx(Share2, { className: "size-4" }), "Spiel Teilen"]
									}),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("span", {
											...
											children: [/* @__PURE__ */ jsx(Smartphone, { className: "size-4 text-emerald-400" }), " Als App installieren"]
										}), /* @__PURE__ */ jsxs("span", { children: [
											"Tippe im Menü deines Browsers auf",
											/* @__PURE__ */ jsx("br", {}),
											/* @__PURE__ */ jsx("b", { children: "\"Zum Startbildschirm hinzufügen\"" }),
											"."
										] })]
									})
								]
				...
				(hud.mode === "playing" || hud.mode === "paused") && /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(IconBtn, {
							...
							children: hud.muted ? /* @__PURE__ */ jsx(VolumeX, { className: "size-5" }) : /* @__PURE__ */ jsx(Volume2, { className: "size-5" })
						}), /* @__PURE__ */ jsx(IconBtn, {
							label: hud.mode === "paused" ? "Weiter" : "Pause",
							onClick: () => hud.mode === "paused" ? engine?.resume() : engine?.pause(),
							children: hud.mode === "paused" ? /* @__PURE__ */ jsx(Play, { className: "size-5" }) : /* @__PURE__ */ jsx(Pause, { className: "size-5" })
						})]
					}),
					omaLine && playing && /* @__PURE__ */ jsx("div", {
					...
					return /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("p", {
									className: "mt-1 text-xs text-paper-dim",
									children: ["Spieler: ", /* @__PURE__ */ jsxs("span", {
										className: "font-bold text-amber-400",
										children: [getActiveBadgeIcon(statsTarget?.equipped) && /* @__PURE__ */ jsx("span", {
											className: "mr-1 text-sm",
										...
										children: [
											(() => {
												...
												return /* @__PURE__ */ jsxs(Fragment, { children: [
													...
													/* @__PURE__ */ jsx("dt", { children: "Gesamt-Erfahrung" }),
													/* @__PURE__ */ jsxs("dd", {
											...
											/* @__PURE__ */ jsx("dt", { children: "Rekord" }),
											/* @__PURE__ */ jsxs("dd", {
												className: "text-right font-mono font-bold text-amber-400",
												children: [statsTarget.highScore || 0, " Pkt"]
											}),
											!inspectedPlayer && /* @__PURE__ */ jsxs(Fragment, { children: [
												/* @__PURE__ */ jsx("dt", { children: "Gespielte Runden" }),
												/* @__PURE__ */ jsx("dd", {
													className: "text-right font-mono font-bold text-paper",
													children: statsTarget.gamesPlayed || 0
												}),
												/* @__PURE__ */ jsx("dt", { children: "Gesamte Treffer" }),
												/* @__PURE__ */ jsx("dd", {
													className: "text-right font-mono font-bold text-paper",
													children: statsTarget.totalHits || 0
												}),
												/* @__PURE__ */ jsx("dt", { children: "Ø Treffer / Runde" }),
												/* @__PURE__ */ jsx("dd", {
													className: "text-right font-mono font-bold text-paper",
				...
				showPwModal && /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							pwChangeSuccess ? /* @__PURE__ */ jsx("div", {
				...
				hud.mode === "paused" && /* @__PURE__ */ jsxs(Modal, { children: [/* @__PURE__ */ jsx("p", {
				...
				hud.mode === "results" && resultsDelay && /* @__PURE__ */ jsxs("div", {
				...
				hud.mode === "results" && !resultsDelay && /* @__PURE__ */ jsxs(Modal, { children: [
					/* @__PURE__ */ jsx("p", {
					...
					/* @__PURE__ */ jsxs("dl", {
						...
						children: [
							/* @__PURE__ */ jsx("dt", { children: "Treffer" }),
							/* @__PURE__ */ jsxs("dd", {
							...
							/* @__PURE__ */ jsx("dt", { children: "Genauigkeit" }),
							/* @__PURE__ */ jsxs("dd", {
								className: "text-right tabular-nums text-paper",
								children: [accuracy, "%"]
							}),
							/* @__PURE__ */ jsx("dt", { children: "Beste Combo" }),
							/* @__PURE__ */ jsx("dd", {
								className: "text-right tabular-nums text-paper",
