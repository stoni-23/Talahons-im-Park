	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				canClaimNow ? /* @__PURE__ */ jsxs("button", {
					type: "button",
...
var GameEngine = class {
	...
	spawnCarpet() {
		...
		import("./audio-CMSNl_p5.js").then((a) => a.playTalahinIntro());
		const fromRight = Math.random() < .5;
		const speed = 190;
		this.targets.push({
			...this.baseTarget(),
	...
	spawnRocker() {
		...
		import("./audio-CMSNl_p5.js").then((a) => a.playRocker());
		const fromRight = Math.random() < .5;
		const speed = 260;
		this.targets.push({
			...this.baseTarget(),
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: "Gesamt:" }), /* @__PURE__ */ jsxs("span", {
									className: "font-mono font-bold text-white tabular-nums text-sm",
									children: [endXpDisplay.liveTotal.toLocaleString(), " XP"]
								})]
							}),
							endXpDisplay.newLevel > endXpDisplay.oldLevel && /* @__PURE__ */ jsx("div", {
